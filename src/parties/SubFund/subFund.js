...
class SubFund extends Party {
   ...
   * @param {number} params.assetManagerId - Asset Manager ID of the SubFund
   * @param {string} params.partyId - Party ID of the SubFund
   * @param {string} params.partyStatus=Active - Status of the SubFund (e.g. 'Active')
   ...
   * @param {object} params.addresses - Object of Addresses associated with this SubFund
   * @param (object) params.emails - Object of Emails associated with this SubFund
   * @param {object} params.references - Object of References associated with this SubFund
