 ...
 */
var Split = function (_CorporateAction) {
  _inherits(Split, _CorporateAction);
  ...
  function Split(_ref) {
    ...
    var _this = _possibleConstructorReturn(this, (Split.__proto__ || Object.getPrototypeOf(Split)).call(this, {
      createdBy: createdBy,
      updatedBy: updatedBy,
