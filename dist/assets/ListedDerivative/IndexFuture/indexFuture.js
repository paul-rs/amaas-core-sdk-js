...
var IndexFuture = function (_Future) {
   ...
   * @param {string} [params.assetType] - Type of the Index Future. Auto-set based on the class or subclass constructor
   ...
   * @param {string} [params.displayName] - Display name of the Index Future
